...
{
  (*ostream_) << "f " << std::get<0>(v1_vt1) << "/" << std::get<1>(v1_vt1) << " " << std::get<0>(v2_vt2) << "/" << std::get<1>(v2_vt2) << " " << std::get<0>(v3_vt3) << "/" << std::get<1>(v3_vt3) << "\n";
}
...
{
  (*ostream_) << "f " << std::get<0>(v1_vn1) << "//" << std::get<1>(v1_vn1) << " " << std::get<0>(v2_vn2) << "//" << std::get<1>(v2_vn2) << " " << std::get<0>(v3_vn3) << "//" << std::get<1>(v3_vn3) << "\n";
}
...
{
  (*ostream_) << "f " << std::get<0>(v1_vt1_vn1) << "/" << std::get<1>(v1_vt1_vn1) << "/" << std::get<2>(v1_vt1_vn1) << " " << std::get<0>(v2_vt2_vn2) << "/" << std::get<1>(v2_vt2_vn2) << "/" << std::get<2>(v2_vt2_vn2) << " " << std::get<0>(v3_vt3_vn3) << "/" << std::get<1>(v3_vt3_vn3) << "/" << std::get<2>(v3_vt3_vn3) << "\n";
}
...
{
  (*ostream_) << "f " << std::get<0>(v1_vt1) << "/" << std::get<1>(v1_vt1) << " " << std::get<0>(v2_vt2) << "/" << std::get<1>(v2_vt2) << " " << std::get<0>(v3_vt3) << "/" << std::get<1>(v3_vt3) << " " << std::get<0>(v4_vt4) << "/" << std::get<1>(v4_vt4) << "\n";
}
...
{
  (*ostream_) << "f " << std::get<0>(v1_vn1) << "//" << std::get<1>(v1_vn1) << " " << std::get<0>(v2_vn2) << "//" << std::get<1>(v2_vn2) << " " << std::get<0>(v3_vn3) << "//" << std::get<1>(v3_vn3) << " " << std::get<0>(v4_vn4) << "//" << std::get<1>(v4_vn4) << "\n";
}
...
{
  (*ostream_) << "f " << std::get<0>(v1_vt1_vn1) << "/" << std::get<1>(v1_vt1_vn1) << "/" << std::get<2>(v1_vt1_vn1) << " " << std::get<0>(v2_vt2_vn2) << "/" << std::get<1>(v2_vt2_vn2) << "/" << std::get<2>(v2_vt2_vn2) << " " << std::get<0>(v3_vt3_vn3) << "/" << std::get<1>(v3_vt3_vn3) << "/" << std::get<2>(v3_vt3_vn3) << " " << std::get<0>(v4_vt4_vn4) << "/" << std::get<1>(v4_vt4_vn4) << "/" << std::get<2>(v4_vt4_vn4) << "\n";
}
...
{
  (*ostream_) << " " << std::get<0>(v_vt) << "/" << std::get<1>(v_vt);
}
...
{
  (*ostream_) << " " << std::get<0>(v_vn) << "//" << std::get<1>(v_vn);
}
...
{
  (*ostream_) << " " << std::get<0>(v_vt_vn) << "/" << std::get<1>(v_vt_vn) << "/" << std::get<2>(v_vt_vn);
}
...
bool obj_to_obj_converter::convert(std::istream& istream, std::ostream& ostream)
{
  ...
  obj_parser.info_callback(std::bind(&obj_to_obj_converter::info_callback, this, ifilename, _1, _2));
  obj_parser.warning_callback(std::bind(&obj_to_obj_converter::warning_callback, this, ifilename, _1, _2));
  obj_parser.error_callback(std::bind(&obj_to_obj_converter::error_callback, this, ifilename, _1, _2));

  obj_parser.geometric_vertex_callback(std::bind(&obj_to_obj_converter::geometric_vertex_callback, this, _1, _2, _3));
  obj_parser.texture_vertex_callback(std::bind(&obj_to_obj_converter::texture_vertex_callback, this, _1, _2));
  obj_parser.vertex_normal_callback(std::bind(&obj_to_obj_converter::vertex_normal_callback, this, _1, _2, _3));
  obj_parser.face_callbacks(
    std::bind(&obj_to_obj_converter::triangular_face_geometric_vertices_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::triangular_face_geometric_vertices_texture_vertices_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::triangular_face_geometric_vertices_vertex_normals_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::triangular_face_geometric_vertices_texture_vertices_vertex_normals_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::quadrilateral_face_geometric_vertices_callback, this, _1, _2, _3, _4),
    std::bind(&obj_to_obj_converter::quadrilateral_face_geometric_vertices_texture_vertices_callback, this, _1, _2, _3, _4),
    std::bind(&obj_to_obj_converter::quadrilateral_face_geometric_vertices_vertex_normals_callback, this, _1, _2, _3, _4),
    std::bind(&obj_to_obj_converter::quadrilateral_face_geometric_vertices_texture_vertices_vertex_normals_callback, this, _1, _2, _3, _4),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_begin_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_vertex_callback, this, _1),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_end_callback, this),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_begin_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_vertex_callback, this, _1),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_end_callback, this),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_vertex_normals_begin_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_vertex_normals_vertex_callback, this, _1),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_vertex_normals_end_callback, this),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_vertex_normals_begin_callback, this, _1, _2, _3),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_vertex_normals_vertex_callback, this, _1),
    std::bind(&obj_to_obj_converter::polygonal_face_geometric_vertices_texture_vertices_vertex_normals_end_callback, this)
  );
  obj_parser.group_name_callback(std::bind(&obj_to_obj_converter::group_name_callback, this, _1));
  obj_parser.smoothing_group_callback(std::bind(&obj_to_obj_converter::smoothing_group_callback, this, _1));
  obj_parser.object_name_callback(std::bind(&obj_to_obj_converter::object_name_callback, this, _1));
  obj_parser.material_library_callback(std::bind(&obj_to_obj_converter::material_library_callback, this, _1));
  obj_parser.material_name_callback(std::bind(&obj_to_obj_converter::material_name_callback, this, _1));
  obj_parser.comment_callback(std::bind(&obj_to_obj_converter::comment_callback, this, _1));
